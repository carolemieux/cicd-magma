...
apt-get update && apt-get install -y $LLVM_DEP_PACKAGES
apt-get update && apt-get install -y llvm-9 llvm-9-dev llvm-9-tools clang-9 gawk

update-alternatives \
    --install /usr/lib/llvm              llvm             /usr/lib/llvm-9             200\
